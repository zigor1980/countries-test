  ...
  if (process.env.NODE_PATH) {
    console.log(
      chalk.yellow(
        ...
        + ' favor of setting baseUrl in jsconfig.json (or tsconfig.json if you are using '
        + 'TypeScript) and will be removed in a future major release of create-react-app.',
      ),
    );
    console.log();
  }
